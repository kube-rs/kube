...
use k8s_openapi::api::authorization::v1::{SelfSubjectRulesReviewSpec, SelfSubjectRulesReviewStatus};
impl Api<Object<SelfSubjectRulesReviewSpec, SelfSubjectRulesReviewStatus>> {
