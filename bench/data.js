    ...
    "Benchmark": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "5afcf191a16d1ebd2e63e6e1589686b7dcd5a466",
          "message": "Avoid deep-cloning ObjectMeta per event in trigger_owners (#2039)\n\ntrigger_owners cloned the whole ObjectMeta (labels, annotations, managedFields)\nto read only namespace and owner_references. obj is owned in the mapper, so take\nthe metadata with std::mem::take instead of deep-cloning it on every owned-child\nevent.\n\nSigned-off-by: doxxx93 <doxxx93@gmail.com>",
          "timestamp": "2026-07-16T09:48:35+01:00",
          "tree_id": "1800012367c9174975b5e10457c8eb3b8f8854e0",
          "url": "https://github.com/kube-rs/kube/commit/5afcf191a16d1ebd2e63e6e1589686b7dcd5a466"
        },
        "date": 1784191830734,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "fe44fa25f7368fe6d771d43e2141cd282e9921bf",
          "message": "Amortize PredicateFilter cache eviction across polls (#2040)\n\nPredicateFilter::poll_next scanned and evicted the entire cache on every poll,\nincluding when the inner stream returns Pending, an O(cache) walk per wakeup.\nReclaim expired entries only once per TTL and enforce per-entry freshness at\nlookup, so the set of emitted events is unchanged. Also collapse the get+insert\ndouble lookup into a single entry() probe.\n\nSigned-off-by: doxxx93 <doxxx93@gmail.com>",
          "timestamp": "2026-07-16T10:13:59Z",
          "tree_id": "950997d21016b418590ef9e203bfe3bd06d6eef2",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "526f1f2cfa996ed0e92510feabb2d2327df5e49f",
          "message": "release 4.2.0",
          "timestamp": "2026-07-22T09:40:53+01:00",
          "tree_id": "e55d621fc6e8c54cdc146f94a60bc89aeb7b62f1",
          "url": "https://github.com/kube-rs/kube/commit/526f1f2cfa996ed0e92510feabb2d2327df5e49f"
        },
        "date": 1784709904562,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "f8a8d474784a40716a5198aa81b36dc8ff1912be",
          "message": "derive: Run integration tests locally and in CI (#2052)\n\n* derive: Run integration tests for kube-derive via just test\n\nSigned-off-by: Techassi <git@techassi.dev>\n\n* derive: Run integration tests for kube-derive in CI\n\nSigned-off-by: Techassi <git@techassi.dev>\n\n* client: Install rustls crypto provider\n\nSigned-off-by: Techassi <git@techassi.dev>\n\n* client: Remove rustls crypto provider\n\nSigned-off-by: Techassi <git@techassi.dev>\n\n* client: Gate unit test with rustls feature\n\nSigned-off-by: Techassi <git@techassi.dev>\n\n---------\n\nSigned-off-by: Techassi <git@techassi.dev>",
          "timestamp": "2026-07-24T13:00:01+01:00",
          "tree_id": "6ab0a1e5e805a5d8efd558576c472f7fe542e0ec",
          "url": "https://github.com/kube-rs/kube/commit/f8a8d474784a40716a5198aa81b36dc8ff1912be"
        },
        "date": 1784894459544,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "b60b81c88d37ab1f1f0d1ff7d42ab0ca268b4221",
          "message": "Allow PredicateFilter to work with dynamic objects (#2054)\n\n* Remove the default trait bound on predicate filter\n\nThis allows the predicate filter to work with dynamic resources.\n\nSigned-off-by: Kai Wohlfahrt <kai.wohlfahrt@gmail.com>\n\n* Add test to cover dynamic object\n\nSigned-off-by: Kai Wohlfahrt <kai.wohlfahrt@gmail.com>\n\n* Remove redundant test\n\nSigned-off-by: Kai Wohlfahrt <kai.wohlfahrt@gmail.com>\n\n* Further reduce type bounds\n\nSigned-off-by: Kai Wohlfahrt <kai.wohlfahrt@gmail.com>\n\n---------\n\nSigned-off-by: Kai Wohlfahrt <kai.wohlfahrt@gmail.com>",
          "timestamp": "2026-07-28T15:42:27+01:00",
          "tree_id": "ca7ff05c670f817ba4b69eead6138b34601343ec",
          "url": "https://github.com/kube-rs/kube/commit/b60b81c88d37ab1f1f0d1ff7d42ab0ca268b4221"
        },
        "date": 1785254377033,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          "author": {
            "email": "43983236+meowjesty@users.noreply.github.com",
            "name": "meowjesty",
            "username": "meowjesty"
          },
          "committer": {
          ...
          "distinct": true,
          "id": "e3403ab6c2d4580a9e83ac044ef9e2fed57e32f7",
          "message": "Derive ordering for label selector expressions (#2058)\n\nSigned-off-by: meowjesty <meowjesty_nyan@outlook.com>",
          "timestamp": "2026-08-04T19:49:16+01:00",
          "tree_id": "47601f6f71a9bc5505fcd2ecd835954d69cac7b1",
          "url": "https://github.com/kube-rs/kube/commit/e3403ab6c2d4580a9e83ac044ef9e2fed57e32f7"
        },
        "date": 1785870890088,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "7a4641d4cc2f693b2dee97b9fc15fadb96d7f62e",
          "message": "Handle API errors in watch responses (#2062)\n\nSigned-off-by: doxxx93 <doxxx93@gmail.com>",
          "timestamp": "2026-08-29T14:08:33+01:00",
          "tree_id": "0d10380a9ebcd462820f8a2ba7508e969d696c16",
          "url": "https://github.com/kube-rs/kube/commit/7a4641d4cc2f693b2dee97b9fc15fadb96d7f62e"
        },
        "date": 1788009041443,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "bb2e548219fc30824c96512bc514c20276ba2357",
          "message": "Expose concrete types in functions that return `impl AsyncRead/AsyncWrite` (#2059)\n\nExpose concrete types in functions that return impl AsyncRead/AsyncWrite\n\nSigned-off-by: MintSoup <aregak2005@gmail.com>",
          "timestamp": "2026-09-04T02:32:54+01:00",
          "tree_id": "c5179faa17a7d22bf2eb040e2ace15fef40cabee",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "96ee324151ba09b115547f724c0c88d4e9c3dc2d",
          "message": "client: Add unit tests for NoProxy to increase coverage (#2083)\n\nSigned-off-by: Techassi <git@techassi.dev>",
          "timestamp": "2026-09-22T10:15:18+01:00",
          "tree_id": "35dd45304de2fedd29f26aa9e5354029c39474f2",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "b7625b042eb8bbda75e97588047870778d56fbc2",
          "message": "Install rustls crypto provider in gzip builder test (#2085)\n\nSigned-off-by: doxxx93 <doxxx93@gmail.com>",
          "timestamp": "2026-09-23T15:10:47+01:00",
          "tree_id": "9fd628cff5f9ed85f938018be421263e89681f6f",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "020ffda1707c6b2ec3dc4e82373b5e6d17446417",
          "message": "fix minor cargo + clippy lints (#2087)\n\n* fix minor cargo lints\n\nSigned-off-by: clux <sszynrae@gmail.com>\n\n* obivously needed\n\nSigned-off-by: clux <sszynrae@gmail.com>\n\n* fmt\n\nSigned-off-by: clux <sszynrae@gmail.com>\n\n* guess this is too ambitious\n\nSigned-off-by: clux <sszynrae@gmail.com>\n\n* ok this as also\n\nSigned-off-by: clux <sszynrae@gmail.com>\n\n---------\n\nSigned-off-by: clux <sszynrae@gmail.com>",
          "timestamp": "2026-09-24T09:12:11+01:00",
          "tree_id": "b10d88ebc4eeb6a7fb5d6b89dd5372836ecc9275",
          "url": "https://github.com/kube-rs/kube/commit/020ffda1707c6b2ec3dc4e82373b5e6d17446417"
        },
        "date": 1790237574441,
        "tool": "customSmallerIsBetter",
        "benches": [
