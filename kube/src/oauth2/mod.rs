...
pub struct CredentialsClient {
    ...
    pub client: hyper::Client<HttpsConnector<hyper::client::HttpConnector>, hyper::Body>,
}
...
impl CredentialsClient {
    ...
    pub async fn request_token(&self, scopes: &[String]) -> Result<Token> {
        ...
        let req = http::Request::builder()
            .uri(&self.credentials.token_uri)
        ...
        let token_response =
            serde_json::from_str::<TokenResponse>(&text).map_err(ConfigError::OAuth2ParseToken)?;
